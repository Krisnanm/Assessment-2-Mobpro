...
import assessment2.GudangIn.navigation.Screen
import assessment2.GudangIn.ui.theme.AssessmentMobro2Theme
import assessment2.GudangIn.util.SettingsDataStore
...
@Composable
fun ListItem(storage: Storage, onClick: () -> Unit ){
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() }
        ...
        Text(
            text = storage.namaBarang,
            maxLines = 1,
            overflow = TextOverflow.Ellipsis,
            fontWeight = FontWeight.Bold
        )
        Text(
            text = storage.kodeBarang,
            maxLines = 2,
            overflow = TextOverflow.Ellipsis,
        )
        Text(
...
@Composable
fun GridItem(storage: Storage, onClick: () -> Unit) {
    Card (
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() },
